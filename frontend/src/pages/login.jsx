...
const Login = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gray-100 sm:bg-gradient-to-br sm:from-white sm:via-gray-300 sm:to-gray-400 px-4">
      <div className="w-full max-w-lg min-h-[500px] sm:min-h-[550px] bg-white/90 backdrop-blur-md p-8 sm:p-10 rounded-2xl shadow-2xl border border-gray-200 flex flex-col justify-center">
        <h2 className="text-3xl font-extrabold text-center mb-8 bg-gradient-to-r from-gray-700 to-gray-900 bg-clip-text text-transparent">
          Welcome Back!
        </h2>
